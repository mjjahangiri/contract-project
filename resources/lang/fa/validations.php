...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        "contractNo"=>"شماره قولنامه",
        "buyerNationalCode"=>"کد ملی خریدار",
        "buyerName"=>"نام و نام خانوادگی خریدار",
        "buyerMobile"=>"شماره همراه خریدار",
        "buyerPhone"=>"شماره ثابت خریدار",
        "buyerAddress"=>"آدرس خریدار",
        "sellerNationalCode"=>"کد ملی فروشنده",
        "sellerName"=>"نام و نام خانوادگی فروشنده",
        "sellerMobile"=>"شماره همراه فروشنده",
        "sellerPhone"=>"شماره ثابت فروشنده",
        "sellerAddress"=>"آدرس فروشنده",
        "machineType"=>"نوع ماشین",
        "YearOfConstruction"=>"سال ساخت",
        "machineColor"=>"رنگ ماشین",
        "discoloration"=>"رنگ شدگی",
        "hurt"=>"شاسی",
        "description"=>"توضیحات",
        "totalAmount"=>"مبلغ کل",
        "prepayment"=>"پیش پرداخت",
        "prepaymentDate"=>"تاریخ پیش پرداخت",
        "clearing"=>"پرداختی تسویه",
        "clearingDate"=>"تاریخ تسویه",
        "penalty"=>"جریمه",
        "penaltyDate"=>"تاریخ پرداخت جریمه",
        "licenseCost"=>"هزینه سند",
        "contractImage"=>"تصویر قولنامه",
        "insurance"=>"بیمه",
        "fuelCart"=>"کارت سوخت",
        "name" => "نام",
        "username" => "نام کاربری",
